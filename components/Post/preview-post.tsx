...
export const PreviewPost = ({ post }: Props) => {
  ...
  return (
    <Link
      href={`/posts/${slug}`}
      className="w-1/4 h-[40rem] min-w-[24rem] break-keep border items-center justify-between py-10 px-10 text-center border-gray-500 text-xl flex flex-col gap-y-5"
    >
